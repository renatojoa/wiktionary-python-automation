...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { spawn } = require('child_process')
...
&nbsp;
  messageStream() {
    const options = []
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._options.includeSource) <span class="cstat-no" title="statement not covered" >options.push('--no-source')</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._options.includeGherkinDocument) <span class="cstat-no" title="statement not covered" >options.push('--no-ast')</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._options.includePickles) <span class="cstat-no" title="statement not covered" >options.push('--no-pickles')</span>
    ...
    gherkin.on('error', <span class="fstat-no" title="function not covered" >er</span>r =&gt; {
<span class="cstat-no" title="statement not covered" >      protobufMessageStream.emit('error', err)</span>
    })
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Nov 01 2018 00:06:00 GMT+0000 (Coordinated Universal Time)
</div>
</div>
